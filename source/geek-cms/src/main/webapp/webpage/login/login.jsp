...
<%@page import="com.beijing.geek.cms.util.BrowserUtils" %>
...
<div id="login">
    ...
    <div class="inner">
        <div class="logo"><img src="/plug-in/login/images/compressor_logo.png"/>
            <span style="font-size: 28px;font-weight:bold;font-style:oblique;">设备管理系统</span>
        </div>
        <div class="formLogin">
            <form name="formLogin" id="formLogin" action="/index.html" check="checkuser.ajax"
                  method="post">
                ...
                <div class="loginButton">
                    ...
                    <div style="float: right; padding: 3px 0; margin-right: -12px;">
                        ...
                        <br>
                        <%--<t:dictSelect id="langCode" field="langCode" typeGroupCode="lang" hasLabel="false"--%>
...
<div class="clear"></div>
<div id="versionBar">
    <div class="copyright">&copy; 版权归北京精通复盛机械有限公司所有</div>
</div>
<!-- Link JScript-->
