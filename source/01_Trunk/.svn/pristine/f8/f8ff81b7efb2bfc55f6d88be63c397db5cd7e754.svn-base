...
import com.beijing.geek.cms.sys.constant.DataBaseConstant;
...
import com.beijing.geek.cms.sys.domain.user.SysRoleFunction;
...
public class ResourceUtil {
	 ...
	 * 缓存字段分组【缓存】
	 */
	public static Map<String, SysAttrGroup> allAttrGroups = new HashMap<String,SysAttrGroup>();
	/**
	 * 缓存字典【缓存】
	 */
	public static Map<String, List<SysAttrValue>> allTypes = new HashMap<String,List<SysAttrValue>>();
	
	/**
	 * 缓存系统图标【缓存】
	 */
	public static Map<String, SysIcon> allTSIcons = new HashMap<String,SysIcon>();
...
//	public final static boolean fuzzySearch= ResourceUtil.isFuzzySearch();
	...
	public static final CmsUser getSessionUserName() {
		HttpSession session = ContextHolderUtils.getSession();
		if(ClientManager.getInstance().getClient(session.getId())!=null){
			return ClientManager.getInstance().getClient(session.getId()).getUser();

		}else{
            CmsUser u = (CmsUser) session.getAttribute(ResourceUtil.LOCAL_CLINET_USER);
	...
	@Deprecated
	public static final List<SysRoleFunction> getSessionRoleFunction(String roleId) {
		HttpSession session = ContextHolderUtils.getSession();
		if (session.getAttributeNames().hasMoreElements()) {
			List<SysRoleFunction> TSRoleFunctionList = (List<SysRoleFunction>)session.getAttribute(roleId);
