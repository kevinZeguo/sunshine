...
hotel_order.init_table = function () {
    ...
    var orderHtml = '<button class="btn btn-xs btn-info" onclick="confirmOrder(typeId);" onmouseover="jQuery(this).addClass(\'ui-state-hover\');" onmouseout="jQuery(this).removeClass(\'ui-state-hover\')" data-original-title="确认预约">'
        + '确认预订'
        + '</button>';
    var deleteHtml = '<button class="btn btn-xs btn-danger" onclick="deleteOrder(typeId);" onmouseover="jQuery(this).addClass(\'ui-state-hover\');" onmouseout="jQuery(this).removeClass(\'ui-state-hover\');" data-original-title="删除预约">'
        + '删除'
        + '</button>';
    ...
    $(grid_selector).jqGrid({
        ...
        colModel: [
            ...
            {name: 'orderTime', index: 'orderTimeStr', width: 120, fixed: true, sortable: false},
            {name: 'confirmTime', index: 'confirmTimeStr', width: 120, fixed: true, sortable: false},
