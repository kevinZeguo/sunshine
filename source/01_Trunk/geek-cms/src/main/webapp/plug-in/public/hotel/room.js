    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (rooms != null && rooms != '' && rooms.length > 0) {
                ...
                $("#roomTab").html("<tr ><td colspan='4' class='text-weizhi4 padding-top-bottom border-bottom'>无房间信息</td><tr>");
            }
        }
    });
}
