            ...
            if (rooms != null && rooms != '' && rooms.length > 0) {
                ...
                for (var i = 0; i < rooms.length; i++) {
                    ...
                    if (room.perStatus == 0 || room.numRetainRooms == 0) {//预约状态为关闭或是房间为空，则显示满房
                        roomHtml += " <div style='width: 100%;text-align: center'><button style='background-color:darkgray;border-radius: 2px;border: hidden;margin: 5px 5px 5px 5px ;padding: 3px 3px 3px 3px; color: white;font-weight: bolder;' disabled>L’âge de logement</button></div>";
                    } else {
                        roomHtml += "<form action='/ofra.html' type='post'>";
                        ...
                        roomHtml += " <div style='width: 100%;text-align: center'><button style='background-color:#FD8B04;border-radius: 2px;border: hidden;margin: 5px 5px 5px 5px ;padding: 3px 3px 3px 3px; color: white;font-weight: bolder;'>demande</button></div>";
                        roomHtml += "</form>";
                    }
                    "</td>";
                    roomHtml += "</tr>";
                ...
                $("#roomTab").html("<tr ><td colspan='4' class='text-weizhi4 padding-top-bottom border-bottom'>L’information n’est pas</td><tr>");
            }
        }
    });
}
